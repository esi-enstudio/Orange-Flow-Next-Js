...
const loadingTipsBn = [
  ...
  "সিম রিটার্ন পৃষ্ঠায় নেভিগেট করা হচ্ছে...",
  "সিম সিরিয়াল নাম্বারসমূহ ইনপুট দেওয়া হচ্ছে...",
  "ডিএমএস ইঞ্জিনে রিটার্ন রিকোয়েস্ট সাবমিট করা হচ্ছে...",
  "সিম রিটার্ন ট্রানজেকশন প্রক্রিয়া করা হচ্ছে...",
  "ওয়্যারহাউসের সাথে রিটার্ন স্ট্যাটাস যাচাই করা হচ্ছে...",
  "রিটার্ন ফলাফল চূড়ান্ত করা হচ্ছে..."
];
...
export default function SIMReturnPage() {
  ...
  const confirmReturn = async () => {
    ...
    try {
      ...
      toast.success(
        language === "bn"
          ? `সফলভাবে ${res.data.total_processed}টি সিমের রিটার্ন প্রক্রিয়া সম্পন্ন হয়েছে!`
          : `Successfully processed return for ${res.data.total_processed} SIM(s)!`
      );
    } catch (err: any) {
              ...
              <div className="p-5 border-b border-gray-100 dark:border-slate-800/80 bg-gray-50/50 dark:bg-slate-900/30 flex flex-col sm:flex-row gap-4 items-center justify-between">
                <div className="relative w-full max-w-sm">
                  ...
                  <input
                    ...
                    placeholder={language === "bn" ? "সিরিয়াল বা মন্তব্য খুঁজুন..." : "Search serial or remarks..."}
