...
func WhatsAppInitClient(device *store.Device, jid string, deviceID string) {
	...
	// 2026-02+: WhatsApp rejects UserAgent.Platform.WEB for new device
	// pairing with a 405 "client outdated" failure. Clients must identify
	// as MACOS (value 24), matching current WhatsApp Web behavior.
